    ...
    <div className="min-h-screen bg-accent/30" data-testid="patient-dashboard">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-12">
          <Card
            className="rounded-2xl border-none bg-white hover:shadow-lg cursor-pointer"
          ...
          <Card
            ...
            data-testid="quick-action-prescriptions"
          >
            <CardContent className="p-6 text-center">
        ...
        <Card className="rounded-3xl border-none shadow-lg" data-testid="appointments-card">
          ...
          <CardContent>
            {loading ? (
              <p className="text-center text-muted-foreground" data-testid="loading-text">
                Loading...
              </p>
              ...
              <div className="text-center py-12" data-testid="no-appointments">
                ...
                <Button onClick={() => navigate('/patient/book-appointment')} className="rounded-full" data-testid="book-first-appointment">
